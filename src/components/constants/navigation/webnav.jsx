                        ...
                        <nav className='flex items-center space-x-8 items-center'>
                            {navigation.links.map((item) => (
                                <Link
                                    href={item.href}
                                    key={item.id}
                                    className={router.pathname == item.href ? 'text-[#1dbfc1] capitalize font-normal' : 'hover:text-[#1dbfc1] ease-in-out duration-300 text-slate-600 capitalize font-normal'}
                                >
                                    {item.name}
                                </Link>
                            ))}
