  ...
  return (
    ...
    <div className='lg:hidden'>
      <div className='bg-transparent xl:hidden flex justify-between w-full px-8 py-4 items-center border-transparent sm:border-gray-200'>
            ...
            <div id="Main" className={`${show ? "-translate-x-full" : "-translate-x-0"} bg-[#effafa] space-y-2 transform  xl:translate-x-0 xl:rounded-r fixed h-screen top-22 sm:z-20  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 flex-col `}>
